		...
		SITE DÉVELOPPÉ PAR AWHIKAX ET ASSASSIN_CRAFT - DESIGN PAR ADRI526<br/>
		<a href="<?php echo $ContactPath; ?>" id="Contact">CONTACT</a><span id="MobileLinks"> - <a class="ColorZbot" href="?lang=en"><img src="<?php echo $assets_path; ?>/en.png" width="40"/></a></span>
